python manager.py
python manager_snmp.py mapper_1 sysDescr
python manager_snmp.py mapper_2 sysDescr
python manager_snmp.py reducer sysDescr
python manager_snmp.py mapper_1 uptime
python manager_snmp.py mapper_2 uptime
python manager_snmp.py reducer uptime
